	...
	RidesAdapter.prototype.computeRides = function() {
		...
		this.ridesPerDay.forEach(function(day) {
			...
			day.data.forEach(function(rides) {
				...
				/*tmp.push(tmp);
				rides = tmp.filter(function(trace) {
					trace.time = day.metadata.timestamp;
		...
		//console.log("tmpDate : " + tmpDate + ", dateMin : " + dateMin + ", dateMax : " + dateMax);
